// Package signer signs HTTP requests for the WhaleAPI.
package signer
...
var (
	ErrInvalidSignatureText = errors.New("invalid signature text")
...
// Signer signs requests for the WhaleAPI.
type Signer struct{}
...
// Sign computes the WhaleAPI request signature.
...
func (s *Signer) plainText(ctx context.Context, req *http.Request, signedHeaders []string, body []byte) string {
	...
	plain = plain + "|" + headers + "|" + strings.Join(signedHeaders, ";") + "|"
